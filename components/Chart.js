...
const Chart = ({ currentPrice, logoUrl, name, symbol, priceChange, sparkline }) => {
    ...
    return ( <
        ChartPathProvider data = {
            { points: sparkline, smoothingStrategy: 'bezier' } } >
        <
        ...
        /View> <
        Text style = { styles.subtitle } > 7 d < /Text> <
        /View> <
        ...
        <
        Text style = {
            [styles.title, { color: priceChangeColor }] } > { priceChange.toFixed(2) } % < /Text> <
        /View> <
        /View> <
        View style = { styles.chartLineWrapper } >
        <
        ChartPath height = { SIZE / 2 }
        stroke = "black"
        width = { SIZE }
        /> <
        ChartDot style = {
